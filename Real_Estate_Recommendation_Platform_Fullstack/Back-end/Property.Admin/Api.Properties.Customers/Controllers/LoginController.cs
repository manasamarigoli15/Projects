...
namespace Api.Properties.Customers.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Post(LoginRequest request)
        {
            ...
            if (user == null || user.Role == Role.Admin) { return Unauthorized("Login Failed"); }
            else { return Ok(new { Token = GenerateJWTToken(user) }); }
        }
        ...
        string GenerateJWTToken(User user)
        {
            ...
            var token = new JwtSecurityToken("findmyhome",
                                             "findmyhome",
                                             claims,
