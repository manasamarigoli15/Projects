...
namespace Api.Library.Admin.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Add(LoginRequest request)
        {
            ...
            {
                var user = _userService.FindByEmailAndPassword(request.Email
                                                                , request.Password);

                if (user == null || user.Role == Role.User) { return Unauthorized("Login Failed"); }
