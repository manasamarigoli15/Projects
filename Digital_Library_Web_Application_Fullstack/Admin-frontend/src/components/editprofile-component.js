    ...
    return (
        <div className="editprofile-background">
            ...
            <div className="content">
                ...
                <div className="card m-auto mt-3 w-50 h-70">
                    ...
                    <div className="card-footer">
                        ...
                        <div className="mt-3 text-center">
                            <button type="button" className="btn btn-primary me-3 buttons" onClick={onAdminUpdate}>Save changes</button>
                            <Link to="/adminprofile" className="btn btn-warning buttons">Cancel</Link>
                        </div>
                    </div>
                </div>
            </div>
