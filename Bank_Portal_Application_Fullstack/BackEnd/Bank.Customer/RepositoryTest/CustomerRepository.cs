...
namespace RepositoryTest
{
    public class CustomerRepositoryTest
    {
        ...
        public void AddUser_DuplicateUser_ThrowsException()
        {
            ...
            Assert.IsNotNull(newUser);
            Assert.NotZero(newUser.Id);
            Assert.Throws<Customer.Exceptions.DuplicateUserException>(() => customerRepository.Add(user));
        ...
        Customers CreateDummyUser()
        {
            var customer = new Customers
            {
                ...
                adharImg = "https://img.jagranjosh.com/imported/images/E/Articles/Adhaar-Card-Complete-Details.jpg",
                panImg = "https://img.jagranjosh.com/imported/images/E/Articles/Adhaar-Card-Complete-Details.jpg"
