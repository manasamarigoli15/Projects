  ...
  if(search.length > 0)
    ...
    return(
      ...
      <section className="mt-4">
        <div className="row ms-5 text-center"><div className="col-11 col-md-10  col-lg-10 float-sm-end"><b className=" text-muted fs-4 text-center">ACTIVATE ACCOUNTS</b></div></div>
        ...
        <div className="mask d-flex align-items-center h-100 ">
          <div className="container float-sm-end">
            ...
            <tbody>
              {
                       customers.length > 0 && 
                       getSearchData().map((d) => { if(d.status==2){
                        return(
                          
                            <ActiveCustomers item={d}></ActiveCustomers>
                        ) }})
