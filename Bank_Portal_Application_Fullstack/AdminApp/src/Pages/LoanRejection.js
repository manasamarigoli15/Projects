...
import { getCustomerDetailsById,deleteLoanRequest,RejectionReason} from "../services/customerService";
...
function LoanReject()
{
    ...
    let [reason,setreason]=useState({RegistrationId:"",FeedbackType:5,FeedBack:"",AccountNumber:""});
    function onDelete(id)
    {
     ...
     function Reject()
     {
        ...
        reason.AccountNumber=customer.accountNumber;
    ...
    return(
      ...
      <div className="row">
       ...
       <div className="col-10 float-sm-end">
        <section style={{"background-color": "#eee"}} className=" rounded w-90 d-flex justify-content-center h-75 m-md-5  m-sm-4 mt-3 ms-3" >
