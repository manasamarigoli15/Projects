...
function PendingCustomers(props)
{
  return(  <tr>
                ...
                <td className="align-middle text-center text-sm col-3">
                <span className="badge badge-sm bg-danger bg-gradient">pending</span>
                </td>
                <td className="align-middle text-center text-sm col-3">
                 <Link to={"/pendingCustProfile/"+ props.item.id } className="btn btn-warning mt-3 rounded text-center"><strong><i class="bi bi-eye"></i><prev> View</prev></strong></Link>
                </td></tr>
