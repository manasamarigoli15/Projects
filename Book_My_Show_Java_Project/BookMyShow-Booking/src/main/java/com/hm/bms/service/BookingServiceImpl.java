...
//		System.out.println("hi");
		...
		ResponseEntity<User> userObject = rt.exchange("http://bookmyshow-auth/auth/userDetails/"+bookingRequest.getUsername(),HttpMethod.GET,httpEntity,User.class );
